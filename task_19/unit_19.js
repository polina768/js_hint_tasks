...
function t2(evt) {
    document.querySelector(".out-2").innerHTML = evt.altKey;
}
...
function t3() {
    ...
    document.querySelector(".out-3").innerHTML = `${w3 += 5}`;
}
...
// ваше событие здесь!!!
document.querySelector(".div-11").addEventListener("mouseenter", t11_1);
document.querySelector(".div-11").addEventListener("mouseleave", t11_2);
// Task 12 ============================================
...
function t16() {
    ...
    document.querySelector(".out-16").innerHTML = `${w3++}`;
}
...
function t18() {
    let wdt = document.querySelector(".div-18");
    let wtdValue = wdt.offsetWidth;
    document.querySelector(".out-18").innerHTML = `Width = ${wtdValue}`;
}
...
function t19() {
    document.querySelector(".out-19").innerHTML += this.className;
}
